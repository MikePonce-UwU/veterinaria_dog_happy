...
<div class="row">
    <div class="col-sm-12 col-md-8">
        <div class="form-group">
            <label>Nombre</label>
            <input type="text" wire:model.lazy="name" class="form-control" placeholder="ej: Dog Happy">
            @error('name')
    ...
    <div class="col-sm-12 col-md-4">
        <div class="form-group">
            ...
            <input type="text" wire:model.lazy="phone" class="form-control" placeholder="ej: +505 87654217"
                maxlength="10">
            @error('phone')
                <span class="text-danger er">{{ $message }}</span>
            @enderror
