...
<div class="col-sm-12 col-md-8">
	<div class="form-group">
		...
		class="form-control product-name" placeholder="ej: Jabon antipulgas" autofocus >
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		...
		<div class="switch-button">
			No <input type="checkbox" name="switch-button" id="switch-label" wire:model="dosis" class="switch-button__checkbox">
			<label for="switch-label" class="switch-button__label"></label> Si
		</div>
		
		@error('dosis') <span class="text-danger er">{{ $message}}</span>@enderror
	</div>
</div>
