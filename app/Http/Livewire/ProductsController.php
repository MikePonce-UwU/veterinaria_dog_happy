...
class ProductsController extends Component
{
	...
	public $name, $barcode, $cost, $price, $stock, $alerts, $categoryid, $search, $image, $selected_id, $pageTitle, $componentName, $dosis;
	...
	public function updatedDosis($value)
    {
        // dd($value);
        if ($value) {
            $this->dosis = 1;
